...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.consent a{color:#1a5fa0;text-decoration:underline;text-underline-offset:3px}'
      ...
      + '.consent-yes{background:#1a5fa0;color:#fff;border:1px solid #1a5fa0}'
      + '.consent-yes:hover{background:#123f6b}'
